...
#define GPIO_PIN_05 GpioAction::BUTTON_PRESS_B3    // LEFT   | LEFT   | LEFT    | LEFT     | LEFT   | LEFT   |
...
#define GPIO_PIN_10 GpioAction::BUTTON_PRESS_UP    // B3     | X      | Y       | Square   | 1      | P1     |
#define GPIO_PIN_11 GpioAction::BUTTON_PRESS_RIGHT // B4     | Y      | X       | Triangle | 4      | P2     |
#define GPIO_PIN_12 GpioAction::BUTTON_PRESS_DOWN  // R1     | RB     | R       | R1       | 6      | P3     |
#define GPIO_PIN_13 GpioAction::BUTTON_PRESS_LEFT  // L1     | LB     | L       | L1       | 5      | P4     |
